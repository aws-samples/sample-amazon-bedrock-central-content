...
date: "2024-08-22"
specifications:
  description: Jamba 1.5 Large is AI21 Labs' hybrid SSM-Transformer model with 398B total parameters and a 256K context window, optimized for complex reasoning tasks across long documents.
  provider: AI21 Labs
  ...
  pricingOutputPer1k: 0.008
  pricingPer1k: 0.01
  pricingPercentile: 77
  pricingTier: "$$$"
  pricingUnit: "token"
codeExamples:
  - title: Invoke API
