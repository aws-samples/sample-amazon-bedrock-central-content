...
date: "2025-04-29"
specifications:
  description: Qwen3 32B is Qwen's 32-billion parameter dense model with hybrid thinking modes for both fast responses and deep reasoning.
  provider: Qwen
  ...
  pricingPer1k: 0.00045
  pricingPercentile: 26
  pricingTier: "$"
  pricingUnit: "token"
codeExamples:
  - title: Invoke API
