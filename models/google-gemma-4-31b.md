...
date: "2025-06-10"
specifications:
  description: Gemma 4 31B is Google's 30.7-billion parameter dense model with built-in reasoning, native function calling, and multimodal input across text and image, supporting a 256K token context window.
  provider: Google
...
resources:
  documentation:
    - title: AWS Model Card — Gemma 4 31B
