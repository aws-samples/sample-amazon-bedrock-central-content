...
date: "2025-12-02"
specifications:
  description: Ministral 3B is Mistral AI's ultra-compact 3-billion parameter model for on-device tasks requiring minimal compute.
  provider: Mistral AI
...
resources:
  documentation:
    - title: AWS Model Card — Ministral 3B
