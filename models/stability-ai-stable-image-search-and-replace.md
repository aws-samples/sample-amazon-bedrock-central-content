---
title: Stable Image Search and Replace
date: "2024-08-06"
specifications:
  description: Stable Image Search and Replace is Stability AI's model that finds objects in images and replaces them with new content based on text prompts.
...
resources:
  documentation:
    - title: AWS Model Card — Stable Image Search and Replace
      url: https://docs.aws.amazon.com/bedrock/latest/userguide/model-card-stability-ai-stable-image-search-and-replace.html
      type: model-card
  aws:
